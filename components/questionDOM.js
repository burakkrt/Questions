...
export default function questionDOM(questionsArray) {
    if (questionsArray.length > 0) {
        ...
        // DOM 'a aktarırken content 'in içindeki cardlar temizleneceği için tailwind css stilleri otomatik silecektir.
        // gerekli stilleri convertTailwind.css dosyasına elle oluştur.
